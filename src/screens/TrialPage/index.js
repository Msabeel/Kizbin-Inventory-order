            ...
            <View style={[styles.center, { flex: 1, opacity: 0.5 }]}>
              ...
              <View style={styles.failedMsgBox}>
                <Text style={styles.failedMsg}>
                  {labels.trialalert1 + " " + props.navigation.state.params.days + " " + labels.trialalert2}
                </Text>
                ...
                >
                  <Text style={styles.failedText}>{labels.toprogram}</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => props.navigation.navigate("SubscriptionExpiration")}
                >
                  <Text style={styles.failedText}>{labels.managesubs}</Text>
                </TouchableOpacity>
                <View style={styles.failedDescriptionBox}>
                  <Text style={styles.paymentBullets}>
                    {labels.selectCont}
                  </Text>
                  <Text style={styles.paymentBullets}>
                    {labels.autoRenew}
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', marginTop: 10, marginBottom: 10 }}>
                  <View style={{ width: '50%', alignItems: 'center' }}>
                    <Text style={{ ...styles.subscriptionText, textAlign: 'center', color: 'blue', fontSize: 15, textAlign: 'justify' }}>{labels.terms}</Text>

                  </View>
                  <View style={{ width: '50%', alignItems: 'center' }}>
                    <Text style={{ ...styles.subscriptionText, textAlign: 'center', color: 'blue', fontSize: 15, textAlign: 'justify' }}>{labels.privacy}</Text>
